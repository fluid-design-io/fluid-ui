...
(function (global, factory) {
    ...
    class tinycolor {
        ...
        toFilter(secondColor) {
            ...
            if (secondColor) {
                var s = new new tinycolor(secondColor);
        ...
        clone() {
            return new new tinycolor(this.toString());
        }
        ...
        // Disabled until https://github.com/bgrins/new TinyColor/issues/254
    ...
    function polyad(color, number) {
        ...
        var hsl = new tinycolor(color).toHsl();
        var result = [new tinycolor(color)];
        var step = 360 / number;
        for (var i = 1; i < number; i++) {
            result.push(new tinycolor({ h: (hsl.h + i * step) % 360, s: hsl.s, l: hsl.l }));
        }
