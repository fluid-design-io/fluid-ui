        ...
        role === 'separator' ? (
          ...
          <button
            ...
            className={clsxm(
              ...
              !horizontal && 'flex items-center justify-start w-full',
          ...
          >
            {Icon && (
              <span className="rtl:hidden">{typeof Icon === 'function' ? <Icon className="h-4 w-4" /> : Icon}</span>
            )}
