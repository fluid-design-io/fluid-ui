...
export const Accordion: FC<AccordionProps> = ({ children, divider, ...props }): JSX.Element => {
  const theme = useTheme().theme.accordion;
  return <div className={clsxm(theme.base, divider && theme.divider, props?.className)}>{children}</div>;
};
