...
// map the colors into an object containing the color name and the color value
...
const contrastColor = (value, step = undefined, blackWhite = false) => {
    ...
    if (typeof value === 'object') {
        ...
        return luminance > 128 ? blackWhite ? '#000' : combineAlpha(checkDarkness(color, 'dark'), alpha) : blackWhite ? '#FFF' : combineAlpha(checkDarkness(color, 'light'), alpha);
    }
    return value;
}
...
const generateTxtBg = (value, step, blackWhite = false, textValue = undefined, textStep = undefined, textBW = undefined) => {
...
const generateTxtStates = (value, {
    ...
    '&:disabled': {
        ...generateTxtBg(disabled.value, disabled.step, disabled.bw, textDisabled?.value, textDisabled?.step, textDisabled?.bw),
        'cursor': 'not-allowed',
    }
})
const generateCMBtn = (value, {
    bw, bc, bs, fw, hocus, active
}) => ({
    'border-width': bw,
    'border-color': bc,
    'box-shadow': bs,
    ...
    return {
        ...
        'btn': (value) => ({
            ...
            ...generateCMClass({
                ...
                ...generateCMBtn(value, { bw: '1px', bc: getColor(value, 500), bs: `inset 0 0 0 1px ${getColor(value, 500)}, 0 0px 0px 2px ${getColor(value, 900)}`, fw: 'bold', hocus: generateTxtBg(value, 700, true), active: generateTxtBg(value, 900, true) }),
                '.dark &': {
                    ...generateTxtBg(value, 900, true),
                    ...generateCMBtn(value, { bw: '1px', bc: getColor(value, 900), bs: `inset 0 0 0 1px ${getColor(value, 900)}, 0 0px 0px 2px ${getColor(value, 50)}`, fw: 'bold', hocus: generateTxtBg(value, 50, true), active: generateTxtBg(value, 300, true) })
                }
            })
        ...
        'btn-light': (value) => ({
            ...
            ...generateCMClass({
                ...generateTxtBg(value, 50, true),
                ...generateCMBtn(value, { bw: '1px', bc: getColor(value, 500), bs: `inset 0 0 0 1px ${getColor(value, 500)}, 0 0px 0px 1px ${getColor(value, 900)}`, fw: 'bold', hocus: generateTxtBg(value, 700, true), active: generateTxtBg(value, 900, true) }),
                '.dark &': {
                    ...generateTxtBg(value, 900, true),
                    ...generateCMBtn(value, { bw: '1px', bc: getColor(value, 900), bs: `inset 0 0 0 1px ${getColor(value, 900)}, 0 0px 0px 1px ${getColor(value, 50)}`, fw: 'bold', hocus: generateTxtBg(value, 50, true), active: generateTxtBg(value, 300, true) })
                }
            })
        }),
        /* ==== END LIGHT BUTTON ==== */
        ...
        'btn-bold': (value) => ({
            ...
            ...generateCMClass({
                ...generateTxtBg(value, 50, true),
                ...generateCMBtn(value, { bw: '3px', bc: getColor(value, 500), bs: `inset 0 0 0 3px ${getColor(value, 500)}, 0 0px 0px 3px ${getColor(value, 900)}`, fw: 'bold', hocus: generateTxtBg(value, 700, true), active: generateTxtBg(value, 900, true) }),
                '.dark &': {
                    ...generateTxtBg(value, 900, true),
                    ...generateCMBtn(value, { bw: '3px', bc: getColor(value, 900), bs: `inset 0 0 0 3px ${getColor(value, 900)}, 0 0px 0px 3px ${getColor(value, 50)}`, fw: 'bold', hocus: generateTxtBg(value, 50, true), active: generateTxtBg(value, 300, true) })
                }
            })
        }),
        /* ==== END BOLD BUTTON ==== */
        ...
        'btn-outline': (value) => ({
            ...
            ...generateCMClass({
                ...
                ...generateCMBtn(value, { bw: '1px', bc: getColor(value, 700), bs: `inset 0 0 0 3px ${getColor(value, 700)}, 0 0px 0px 3px ${getColor(value, 50)}`, fw: 'bold', hocus: generateTxtBg(value, 50, true), active: generateTxtBg(value, 300, true) }),
                '.dark &': {
                    ...generateTxtBg(value, { step: 900, alpha: 0.01 }, false, getColor(value, 100), 50, false),
                    ...generateCMBtn(value, { bw: '1px', bc: getColor(value, 200), bs: `inset 0 0 0 3px ${getColor(value, 700)}, 0 0px 0px 3px ${getColor(value, 100)}`, fw: 'bold', hocus: generateTxtBg(value, 700, true), active: generateTxtBg(value, { step: 900, alpha: 60 }, true, value, 900, true) }),
                }
            })
        }),
    }
...
module.exports =
    plugin(function ({ matchUtilities, addVariant, addComponents, addBase, theme }) {
        matchUtilities(
            ...
            matchUtilities(
                {
                    'bg-grid': (value) => ({
                        'background-image': `url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32' width='32' height='32' fill='none' stroke='${encodeURIComponent(value)}'%3e%3cpath d='M0 .5H31.5V32'/%3e%3c/svg%3e")`
                    }),
                },
