...
export default {
  ...
  button: {
    base:
      'flex justify-center items-center h-min w-fit text-center transition-all gap-2 relative',
    shape: {
      pill: {
    ...
    loading: {
      base:
        'absolute inset-0 z-[2] w-full h-full flex justify-center items-center gap-2',
      animation: {
        spin: 'animate-spin',
        pulse: 'animate-pulse',
        ping: 'animate-ping',
